...
export default function Contact() {
  return (
    <section id="contact" className="mx-auto w-full max-w-[1200px] py-32">
      ...
      <Link
        ...
        className="mt-10 flex items-baseline gap-x-5 text-5xl font-bold"
      >
        <i className="bi bi-envelope text-4xl" />
